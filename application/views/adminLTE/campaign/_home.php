...
<script>
    ...
    <nav class="navbar navbar-static-top">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li>
            <a target="_blank" href="<?= base_url("campaign/page/settings") ?>"><i class="fa fa-gears"></i> Settings</a>
          </li>
          <li>
            <a href="<?= base_url("campaign/logout") ?>" ><i class="fa fa-sign-out"></i> Logout</a>
          </li>
        </ul>
      </div>
  ...
  <!-- Menu -->
  <?php $this->load->view("adminLTE/campaign/_nav"); ?>
