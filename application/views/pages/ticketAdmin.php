         ...
         <div class="box box-solid">
           ...
           <div class="box-body no-padding">
             <ul class="nav nav-pills nav-stacked">
               <li><a href="<?= base_url("admin/page/ticket/") ?>"><i class="fa fa-inbox"></i> All Ticket</a></li>
             </ul>
           </div>
           <!-- /.box-body -->
         </div>
                ...
                <?= (isset($alert))?$alert:null ?>
                 <table class="table table-hover table-striped" id="dynatable">
                   ...
                   <tbody>
                     ...
                     <tr>
                        <td><?= $key->id_tiket ?></td>
                        <td><a href="<?= base_url("admin/page/ticket/detail/".$key->id_tiket) ?>"><?= $key->masalah ?></a></td>
                        ...
                        <td><?= $key->date ?></td>
                        <td><a  href="<?= base_url("admin/page/ticket/detail/".$key->id_tiket)?>" class="btn btn-success" <?= ($key->status > 2)?"style='pointer-events: none; cursor: default;' disabled":null ?>>Reply</a>
                     </tr>
                     <?php } ?>
                   </tbody>
                 </table>
